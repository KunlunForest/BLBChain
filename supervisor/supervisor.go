...
func (d *Supervisor) NewSupervisor(ip string, pcc *params.ChainConfig, committeeMethod string, measureModNames ...string) {
	...
	case "Overhead":
		d.comMod = committee.NewOverheadCommittee(d.Ip_nodeTable)
	case "CLPA_Broker":
	...
	case "Contrib":
		d.comMod = committee.NewContribCommitteeModule(d.Ip_nodeTable, d.Ss, d.sl, params.DatasetFile, params.TotalDataSize, params.TxBatchSize, params.ReconfigTimeGap)
	case "PLouvain":
		d.comMod = committee.NewPLouvainCommitteeModule(d.Ip_nodeTable, d.Ss, d.sl, params.DatasetFile, params.TotalDataSize, params.TxBatchSize, params.ReconfigTimeGap)
	default:
		d.comMod = committee.NewPLouvainCommitteeModule(d.Ip_nodeTable, d.Ss, d.sl, params.DatasetFile, params.TotalDataSize, params.TxBatchSize, params.ReconfigTimeGap)
	}
